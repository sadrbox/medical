...
/*jsc
["saebiz.plugins.image.Plugin","saebiz.core.PluginManager","saebiz.plugins.image.api.Commands","saebiz.plugins.image.core.FilterContent","saebiz.plugins.image.ui.Buttons","global!saebiz.util.Tools.resolve","saebiz.plugins.image.ui.Dialog","saebiz.core.util.Tools","global!Math","global!RegExp","saebiz.plugins.image.api.Settings","saebiz.plugins.image.core.Utils","saebiz.plugins.image.ui.AdvTab","saebiz.plugins.image.ui.MainTab","saebiz.plugins.image.ui.SizeManager","saebiz.plugins.image.ui.UploadTab","global!document","ephox.sand.api.FileReader","saebiz.core.util.Promise","saebiz.core.util.XHR","ephox.sand.api.URL","saebiz.core.ui.Factory","saebiz.plugins.image.core.Uploader","ephox.sand.util.Global","ephox.sand.api.XMLHttpRequest","global!window","ephox.katamari.api.Resolve","ephox.katamari.api.Global"]
jsc*/
...
define(
  'saebiz.core.PluginManager',
  [
    'global!saebiz.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('saebiz.PluginManager');
  }
);
...
define(
  'saebiz.plugins.image.api.Settings',
  [
  ],
  function () {
...
define(
  'saebiz.core.util.Promise',
  [
    'global!saebiz.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('saebiz.util.Promise');
  }
);
...
define(
  'saebiz.core.util.XHR',
  [
    'global!saebiz.util.Tools.resolve'
  ],
  function (resolve) {
    return resolve('saebiz.util.XHR');
  }
);
...
/**
 * @class saebiz.image.core.Utils
 * @private
 */
define(
  'saebiz.plugins.image.core.Utils',
  [
    'global!Math',
    'global!document',
    'ephox.sand.api.FileReader',
...
define(
  'saebiz.plugins.image.ui.AdvTab',
...
define(
  'saebiz.plugins.image.ui.SizeManager',
...
define(
  'saebiz.plugins.image.ui.MainTab',
...
/**
 * This is basically cut down version of saebiz.core.file.Uploader, which we could use directly
 * if it wasn't marked as private.
 */
define(
  'saebiz.plugins.image.core.Uploader',
  [
    'ephox.sand.api.XMLHttpRequest',
    'global!document',
    'global!window',
...
define(
  'saebiz.plugins.image.ui.UploadTab',
...
/**
 * @class saebiz.image.ui.Dialog
 * @private
 */
define(
  'saebiz.plugins.image.ui.Dialog',
  [
    'global!Math',
    'global!RegExp',
    'saebiz.core.util.Tools',
...
define(
  'saebiz.plugins.image.api.Commands',
  [
    'saebiz.plugins.image.ui.Dialog'
  ],
  function (Dialog) {
...
define(
  'saebiz.plugins.image.core.FilterContent',
  [
    'saebiz.core.util.Tools'
  ],
  function (Tools) {
...
define(
  'saebiz.plugins.image.ui.Buttons',
  [
    'saebiz.plugins.image.ui.Dialog'
  ],
  function (Dialog) {
...
dem('saebiz.plugins.image.Plugin')();
})();